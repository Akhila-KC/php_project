...
function get_all_data($con){
    ...
    $get_data=mysqli_query($con,"SELECT * FROM bookseat"); //$get_data is an array execution query oneline
    
    if(mysqli_num_rows($get_data)>0){
        //$get_data here checking >0 if >0 checking next level,$get_data is array
        echo '<table class="table-responsive text-center" border="2px solid black" width="100%" height="450px" style="border: none; margin-top: 5px; border-radius: 10px 10px 10px 10px; padding-top: 50px;">
        <tr class="table">
            <th>Customer Id</th>
            <th>Customer Name</th>
        ...
        echo '<tr class="table">
             ...
             <td>
             <button class="btn btn-danger"><a style="text-decoration: none; color: white;" href="deletebookseat.php?del='.$row['id'].'">Delete</a></button>
             </td>
             </tr>';
        }
        echo '</table>';
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="d-flex justify-content-between">
                          <h4 class="card-title mb-0">Seat Booked Customer Details</h4>
                          <br>           
                        </div>
